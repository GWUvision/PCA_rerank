...
class learn():
    ...
    def opt(self):
        ...
        for epoch in range(self.num_epochs+1): 
            ...
            print(self.criterion.eta)
            if epoch>2:
                self.criterion.semi=False
            elif epoch==0:
                self.criterion.semi=True
    ...
    def tra(self, N_limit=-1):
        ...
        for data in dataLoader:
            ...
            with torch.set_grad_enabled(True):
                ...
                loss, Pos_log, Neg_log, margin,rt = self.criterion(fvec, labels_bt.cuda())
                ...
                self.writer.add_scalar('rt', rt, self.global_it)
                self.global_it+=1
